...
echo grep "CHI2_N_SYM: CHI2, NMEFF, NQUAN, NDOF (DEF) = " average_unitarity_1e-*.log  | awk '{if (NR%2==0) print $0}' >> $LOGFILE
     grep "CHI2_N_SYM: CHI2, NMEFF, NQUAN, NDOF (DEF) = " average_unitarity_1e-*.log  | awk '{if (NR%2==0) print $0}' >> $LOGFILE

echo grep "CHI2_N_SYM: CHI2, NMEFF, NQUAN, NDOF (NEW) = " average_unitarity_1e-*.log  | awk '{if (NR%2==0) print $0}' >> $LOGFILE
     grep "CHI2_N_SYM: CHI2, NMEFF, NQUAN, NDOF (NEW) = " average_unitarity_1e-*.log  | awk '{if (NR%2==0) print $0}' >> $LOGFILE
