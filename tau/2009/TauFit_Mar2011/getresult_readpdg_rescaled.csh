...
rm -f ${TXTFILE}_1 ; grep -A41 -F "Comparison of Results from fit with [errors rescaled in a Ad-Hoc style for kkk only] w.r.t original fit:" $LOGFILE | tail -n +3 | awk '{printf "Gamma%-3s %8.6f %8.6f\n",$3,$8,$9}' > ${TXTFILE}_1
