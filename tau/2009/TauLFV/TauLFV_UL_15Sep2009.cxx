...
void TauLFV_UL(Int_t when=2009002)
{
  SetUp();
  unsigned int ibin;
...
void HFAGTauLabel(Int_t yearversion=2009002, Double_t xpos= .99, Double_t ypos= 0.825, Double_t scale= 1.0) {
