...
int main() {
  ...
  ibase=-1;
  baseseed[++ibase] = /*           M_GAMMA3    */  0.1740554  ; // +/-      0.0003843 +/-      0.0000284 Tot Err:     0.0003854 Check Sys:     0.0000229
  baseseed[++ibase] = /*           M_GAMMA5    */  0.1782447  ; // +/-      0.0003970 +/-      0.0000423 Tot Err:     0.0003993 Check Sys:     0.0000372
  baseseed[++ibase] = /*           M_GAMMA9    */  0.1083477  ; // +/-      0.0005068 +/-      0.0000774 Tot Err:     0.0005127 Check Sys:     0.0000871
  baseseed[++ibase] = /*          M_GAMMA10    */  0.0069951  ; // +/-      0.0000962 +/-      0.0000097 Tot Err:     0.0000967 Check Sys:     0.0000096
  baseseed[++ibase] = /*          M_GAMMA14    */  0.2551001  ; // +/-      0.0008919 +/-      0.0000517 Tot Err:     0.0008934 Check Sys:     0.0000400
  baseseed[++ibase] = /*          M_GAMMA16    */  0.0043266  ; // +/-      0.0001474 +/-      0.0000204 Tot Err:     0.0001488 Check Sys:     0.0000226
  baseseed[++ibase] = /*          M_GAMMA20    */  0.0928630  ; // +/-      0.0009602 +/-      0.0000967 Tot Err:     0.0009651 Check Sys:     0.0000642
  baseseed[++ibase] = /*          M_GAMMA23    */  0.0006311  ; // +/-      0.0002216 +/-      0.0000051 Tot Err:     0.0002217 Check Sys:     0.0000047
  baseseed[++ibase] = /*          M_GAMMA27    */  0.0104871  ; // +/-      0.0007060 +/-      0.0000417 Tot Err:     0.0007073 Check Sys:     0.0000277
  baseseed[++ibase] = /*          M_GAMMA28    */  0.0004640  ; // +/-      0.0002157 +/-      0.0000039 Tot Err:     0.0002157 Check Sys:     0.0000038
  baseseed[++ibase] = /*          M_GAMMA30    */  0.0011176  ; // +/-      0.0003904 +/-      0.0000164 Tot Err:     0.0003907 Check Sys:     0.0000115
  baseseed[++ibase] = /*          M_GAMMA35    */  0.0083274  ; // +/-      0.0001370 +/-      0.0001177 Tot Err:     0.0001806 Check Sys:     0.0001164
  baseseed[++ibase] = /*          M_GAMMA37    */  0.0015883  ; // +/-      0.0001587 +/-      0.0000079 Tot Err:     0.0001589 Check Sys:     0.0000075
  baseseed[++ibase] = /*          M_GAMMA40    */  0.0035193  ; // +/-      0.0001444 +/-      0.0000166 Tot Err:     0.0001454 Check Sys:     0.0000182
  baseseed[++ibase] = /*          M_GAMMA42    */  0.0016151  ; // +/-      0.0001944 +/-      0.0000071 Tot Err:     0.0001945 Check Sys:     0.0000063
  baseseed[++ibase] = /*          M_GAMMA47    */  0.0002453  ; // +/-      0.0000515 +/-      0.0000006 Tot Err:     0.0000515 Check Sys:     0.0000006
  baseseed[++ibase] = /*          M_GAMMA48    */  0.0012253  ; // +/-      0.0002406 +/-      0.0000170 Tot Err:     0.0002412 Check Sys:     0.0000146
  baseseed[++ibase] = /*          M_GAMMA62    */  0.0899763  ; // +/-      0.0003382 +/-      0.0003808 Tot Err:     0.0005094 Check Sys:     0.0002399
  baseseed[++ibase] = /*          M_GAMMA70    */  0.0270063  ; // +/-      0.0006935 +/-      0.0001089 Tot Err:     0.0007020 Check Sys:     0.0000689
  baseseed[++ibase] = /*          M_GAMMA77    */  0.0010045  ; // +/-      0.0003535 +/-      0.0000048 Tot Err:     0.0003535 Check Sys:     0.0000044
  baseseed[++ibase] = /*          M_GAMMA78    */  0.0002252  ; // +/-      0.0000499 +/-      0.0000007 Tot Err:     0.0000499 Check Sys:     0.0000004
  baseseed[++ibase] = /*          M_GAMMA85    */  0.0029510  ; // +/-      0.0000454 +/-      0.0000518 Tot Err:     0.0000689 Check Sys:     0.0000517
  baseseed[++ibase] = /*          M_GAMMA89    */  0.0007680  ; // +/-      0.0001155 +/-      0.0000050 Tot Err:     0.0001156 Check Sys:     0.0000032
  baseseed[++ibase] = /*          M_GAMMA93    */  0.0014432  ; // +/-      0.0000223 +/-      0.0000160 Tot Err:     0.0000274 Check Sys:     0.0000154
  baseseed[++ibase] = /*          M_GAMMA94    */  0.0000610  ; // +/-      0.0000183 +/-      0.0000001 Tot Err:     0.0000183 Check Sys:     0.0000001
  baseseed[++ibase] = /*         M_GAMMA104    */  0.0001792  ; // +/-      0.0000257 +/-      0.0000003 Tot Err:     0.0000257 Check Sys:     0.0000003
  baseseed[++ibase] = /*         M_GAMMA126    */  0.0013954  ; // +/-      0.0000703 +/-      0.0000175 Tot Err:     0.0000724 Check Sys:     0.0000175
  baseseed[++ibase] = /*         M_GAMMA128    */  0.0001614  ; // +/-      0.0000099 +/-      0.0000022 Tot Err:     0.0000102 Check Sys:     0.0000022
  baseseed[++ibase] = /*         M_GAMMA150    */  0.0199380  ; // +/-      0.0006358 +/-      0.0000389 Tot Err:     0.0006370 Check Sys:     0.0000246
  baseseed[++ibase] = /*         M_GAMMA152    */  0.0041079  ; // +/-      0.0004181 +/-      0.0000096 Tot Err:     0.0004182 Check Sys:     0.0000067
  //                             M_GAMMA96      0.0000217 +/-      0.0000014 +/-      0.0000005 Tot Err:     0.0000015 Check Sys:     0.0000005
  //                             M_GAMMA130     0.0000486 +/-      0.0000116 +/-      0.0000006 Tot Err:     0.0000116 Check Sys:     0.0000006
  //                             M_GAMMA132     0.0000942 +/-      0.0000149 +/-      0.0000012 Tot Err:     0.0000149 Check Sys:     0.0000012
  //                             M_GAMMA44      0.0003225 +/-      0.0002278 +/-      0.0000106 Tot Err:     0.0002280 Check Sys:     0.0000080
  //                             M_GAMMA53      0.0002996 +/-      0.0001987 +/-      0.0000077 Tot Err:     0.0001988 Check Sys:     0.0000058
  baseseed[++ibase] = 1- 0.9991570; // M_GAMMA103
  ...
  ifstream ifs("pdginput/s035-fit-no-babar-belle_aleph_hcorr.data") ;
...
//	   << author[nmeas] << " " << year[nmeas] << " " << meastitle[nmeas] << endl;
  ...
  FILE *measfile[2];
  for (int p=0;p<2;++p){
    if (p==0) measfile[0]=fopen("combos_pdginput_measurements_no_babar_belle.input","w");
    if (p==1) measfile[1]=fopen("alucomb_pdginput_measurements_no_babar_belle.input","w");
  ...
  for (int p=0;p<2;++p){
    ...
    if (p==0) fprintf (avefile[p], "INCLUDE combos_pdginput_measurements_no_babar_belle.input \n\n"); 
    if (p==1) fprintf (avefile[p], "INCLUDE alucomb_pdginput_measurements_no_babar_belle.input \n\n"); 
...
//	       << endl;
  ...
  for (int p=0;p<1;++p){
    if (p==0) scaled_measfile[0]=fopen("combos_pdginput_measurements_scaled_no_babar_belle.input","w");
    if (p==1) scaled_measfile[1]=fopen("alucomb_pdginput_measurements_scaled_no_babar_belle.input","w");
    iimeas=0;
    for (int i=0;i<nmeas;++i){
  ...
  for (int p=0;p<1;++p){
    if (p==0) scaled_avefile[0]=fopen("combos_average_pdginput_scaled_no_babar_belle.input","w");
    if (p==1) scaled_avefile[1]=fopen("alucomb_average_pdginput_scaled_no_babar_belle.input","w");
    if (p==0) fprintf (scaled_avefile[p], "INCLUDE combos_pdginput_measurements_scaled_no_babar_belle.input \n\n"); 
    if (p==1) fprintf (scaled_avefile[p], "INCLUDE alucomb_pdginput_measurements_scaled_no_babar_belle.input \n\n"); 
