...
echo "DECAYMODE COMBOS_VAL COMBOS_ERR  PDG_VAL    ERROR   RESCALED  SFACTOR PDG_VAL/ERR 1-COMBOS/PDG_VAL 1-COMBOS/PDG_ERR |1-COMBOS/PDG_VAL|"
paste a1 a2 |  awk '{printf "%s %12.6f %s %12.6f %s %12.6f %s \n", $0, 100.*($5/$4), "%", 100.*(1-($2/$4)), "%", 100.*(1-($3/$5)), "%" }' | awk '{if ($10>0) {print $0,"   ",$10," %"}else{print $0,"   ",-$10," %"}}' | sort -k14 -g
