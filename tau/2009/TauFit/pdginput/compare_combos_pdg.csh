...
echo "DECAYMODE COMBOS_VAL COMBOS_ERR  PDG_VAL    ERROR   RESCALED  SFAC  COMBOS/PDG_VAL COMBOS/PDG_ERR    PDG_VAL/ERR |COMBOS/PDG_VAL|"
paste a1 a2 |  awk '{printf "%s %12.6f %s %12.6f %s %12.6f %s \n", $0, 100.*(($2/$4)-1), "%", 100.*(($3/$5)-1), "%", 100.*($5/$4), "%"}' | awk '{if ($8>0) {print $0,$8}else{print $0,-$8}}' | sort -k14 -g
