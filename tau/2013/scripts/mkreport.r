...
get.tex.base.nodes.corr = function() {
  ...
  corr.pre = c(
    ...
    "\\begin{center}",
    "\\ifhevea",
    "\\caption{Basis quantities correlation coefficients in percent, subtable @@num@@.\\label{tab:tau:br-fit-corr@@num@@}}%",
    "\\else",
    "\\begin{minipage}{\\linewidth}",
    "\\begin{center}",
    "\\captionof{table}{Basis quantities correlation coefficients in percent, subtable @@num@@.}\\label{tab:tau:br-fit-corr@@num@@}%",
    "\\fi",
    "\\begin{envsmall}",
    "\\begin{center}",
