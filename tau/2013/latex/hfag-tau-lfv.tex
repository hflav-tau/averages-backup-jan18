...
\tausection{Upper limits on tau LFV branching fractions}
\cutname{lfv-limits.html}
\label{sec:tau:lfv}
We list in Table~\ref{tab:tau:lfv-upper-limits} the up-to-date upper limits on the tau LFV branching fractions.
\begin{center}
...
\caption{HFAG Winter 2012  upper limit for the lepton flavor violating $\tau$ decay modes. For convenience, the decay modes
  ...
  that the decay mode implies lepton number violation as well as the lepton flavor violation.\label{tab:tau:lfv-upper-limits}}%
\\
\hline
...
\end{ensuredisplaymath}
 ...
 & (L)        & \( <\; \) & \(18.\cdot 10^{-8}\)         & \babar &   \cite{Aubert:2005tp}   \\ 
%\hline
\begin{ensuredisplaymath}
\Gamma_{196} =  {\mu^+ \pi^- K^-} 
\end{ensuredisplaymath}
...
\end{ensuredisplaymath}
 &\(\Lambda\ h\) & \( <\; \) & \(3.0 \cdot 10^{-8}\)         & Belle & \cite{Hayasaka:2011aa}  \\
