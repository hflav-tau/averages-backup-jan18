...
Observables used in the global fit except those from \dkpi\ 
and those used for measuring direct \cpv.}
\vspace*{6pt}
\footnotesize
%\hskip-0.10in
...
%, from Refs.~\cite{Aubert:2007wf,Aaltonen:2007uc,Zhang:2006dp}.}
\vspace*{6pt}
\footnotesize
\begin{center}
\begin{tabular}{l|ccc}
...
Measurements of direct \cpv. The parameter $A^{}_{CP}(f)$
is defined as $[\Gamma(D^0\ra f)-\Gamma(\dbar\ra f)]/
