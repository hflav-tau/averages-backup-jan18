...
\begin{sidewaystable}[p]
  ...
  %from the sum of statistical,
  %systematic and FSR covariances. 
...
%%%%
% OLD VERSION OF THIS PARAGRAPH - before 27 Nov 2014
...
%statistical, systematic (excluding FSR) and FSR uncertainties.  
%The statistical uncertainties are obtained from
...
%%%
% NEW VERSION OF THIS PARAGRAPH - 27 Nov 2014
...
this nominal fit. % (stat.+syst.+FSR).
...
In forming the full covariance matrix, the FSR
uncertainties are treated as fully correlated (or anti-correlated) as 
described above.  % PN after 27 Nov
%In forming the covariance matrix for the FSR uncertainties, the FSR
%uncertainties are treated as fully correlated (or anti-correlated) as 
%described above.  PN before 27 Nov
%For the systematic covariance matrix, ALEPH's systematic
For the covariance matrices involving systematic measurement uncertainties, ALEPH's systematic % Nov 27
...
\begin{table}[!htb]
  ...
  no FSR corrections or correlations (similar to the average in the %PDG 2013 update~\cite{PDG_2012} 
...
%2013 PDG update average~\cite{PDG_2012}. 
