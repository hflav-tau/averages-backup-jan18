...
%Figure~\ref{leveldiagram} shows the levels of excited charm baryons with 
%the corresponding transitions between them or to the charm baryon ground 
%states. 
...
%\begin{figure}[!htb]
%\includegraphics[width=1.0\textwidth]{./figures/charm/ruslan_charm_baryons.eps}
