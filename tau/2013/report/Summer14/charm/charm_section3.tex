...
%\eg\ Ref.~\cite{Boyd:1994tt}), which allow expression of a form
%factor in terms of
...
% Results from the different collaborations have been corrected, if needed, using values from PDG 2010~\cite{Nakamura:2010zzi}. Prior to 2006, and apart from BES II, experiments measure the ratio $(f_+^{\pi}(0)|V_{cd}| / f_+^K(0)|V_{cs}|)^2$. 
...
Assuming unitarity of the CKM matrix, the values of the CKM matrix elements entering in charm semileptonic decays are known 
...
\includegraphics[width=0.47\textwidth]{figures/charm/Kenu_f0r1_ellipses_logo.pdf}\hfill
\includegraphics[width=0.46\textwidth]{figures/charm/sl_new_f0r1_pi_logo.pdf}
\includegraphics[width=0.47\textwidth]{figures/charm/Kenu_f0r2_ellipses_logo.pdf}\hfill
\includegraphics[width=0.46\textwidth]{figures/charm/sl_new_f0r2_pi_logo.pdf}\hfill
\includegraphics[width=0.47\textwidth]{figures/charm/Kenu_r1r2_ellipses_logo.pdf}\hfill
\includegraphics[width=0.46\textwidth]{figures/charm/sl_new_r1r2_pi_logo.pdf}
...
\hline
\hline
%HPQCD & \cite{Na:2011mc,Na:2010uf}             & $0.727\pm0.018$         & $0.150 \pm 0.007$      \\
%\vspace*{-10pt} & \\
%\hline
\end{tabular}
\end{center}
...
The result for the effective mass $m_{D^{\ast ''}_{eff}}$ is larger than the mass of the 
...
\begin{figure}[p]
\begin{center}
\includegraphics[width=0.7\textwidth]{figures/charm/sl_plot3_logo.pdf}
...
\includegraphics[width=.50\textwidth]{figures/charm/sl_ff_compar_cleoc_logo.pdf}
 \end{center}
