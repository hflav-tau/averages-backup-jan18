...
\caption{Measurements of $\bar B\to D^*\ell^-\bar\nu_\ell$ in the
  ...
  to the rescaled measurements of $\eta_\mathrm{EW}{\cal F}(1)\vcb$,
  $\rho^2$, $R_1(1)$ and $R_2(1)$. The $\chi^2$~value of the
  combination is 30.0 for 23 degrees of freedom (CL=$15.0\%$). The
  total  correlation between the average $\eta_\mathrm{EW}{\cal
    F}(1)\vcb$ and $\rho^2$ is 0.323.}
\begin{center}
