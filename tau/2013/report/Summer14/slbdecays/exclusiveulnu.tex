...
%for error sources where the dependence was not obvious had no
%significant impact.
...
the event.
% refer to the type of $B$ tag used in the measurement; ``untagged''
