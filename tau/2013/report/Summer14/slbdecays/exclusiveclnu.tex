% -- \include{b2cexcl.tex}
% ======================================================================
\subsection{Exclusive CKM-favored decays}
...
\begin{figure}[!ht]
  ...
  \begin{picture}(14.,8.0)
    \put(  8.0,
    -0.2){\includegraphics[width=8.0cm]{figures/slb/vcbf1.vs.rho2.eps}}
    \put( -0.5,
    0.0){\includegraphics[width=7.5cm]{figures/slb/vcbf1.eps}}
...
Using the form factor normalization ${\cal F}(1)$ of the latest LQCD
...
\begin{figure}[!ht]
  ...
  \begin{picture}(14.,8.0)  %ys(25.,6.0)
    \put( -0.5, 0.0){\includegraphics[width=7.5cm]{figures/slb/br_dsl_iso.eps}}
    \put(  8.0, 0.0){\includegraphics[width=7.5cm]{figures/slb/br_ds0l.eps}}
    \put(  5.5, 6.8){{\large\bf a)}}
...
\begin{figure}[!ht]
  ...
  \begin{picture}(14.,8.) %ys(25.,6.)
    \put(  8.0, -0.2){\includegraphics[width=8.0cm]{figures/slb/vcbg1.vs.rho2.eps}}
    \put( -0.5,  0.0){\includegraphics[width=7.5cm]{figures/slb/vcbg1.eps}}
    \put(  5.5,  6.8){{\large\bf a)}}
...
\begin{figure}[!ht]
  ...
  \put( -0.5,  0.0){\includegraphics[width=7.55cm]{figures/slb/br_dl_iso.eps}}
  \end{picture}
...
\begin{figure}[!ht]
 \begin{center}
  \unitlength1.0cm % coordinates in cm
  \begin{picture}(14.,8.0)  %ys(25.,6.0)
   \put( -0.5,  0.0){\includegraphics[width=7.55cm]{figures/slb/br_dssIncl-3.eps}}
   \put(  8.0,  0.0){\includegraphics[width=7.8cm]{figures/slb/br_dssIncl-4.eps}}
   \put(  5.5,  6.8){{\large\bf a)}}
   \put( 14.0,  6.8){{\large\bf b)}}
  \end{picture}
  \begin{picture}(14.,8.0)  %ys(25.,6.0)
   \put( -0.5,  0.0){\includegraphics[width=7.55cm]{figures/slb/br_dssIncl-1.eps}}
   \put(  8.0,  0.0){\includegraphics[width=7.8cm]{figures/slb/br_dssIncl-2.eps}}
...
\begin{figure}[!ht]
 \begin{center}
  \unitlength1.0cm % coordinates in cm
  \begin{picture}(14.,8.0)  %ys(25.,6.0)
   \put( -0.5,  0.0){\includegraphics[width=7.55cm]{figures/slb/br_dss1l.eps}}
   \put(  8.0,  0.0){\includegraphics[width=7.8cm]{figures/slb/br_dss2l.eps}}
   \put(  5.5,  6.8){{\large\bf a)}}
   \put( 14.0,  6.8){{\large\bf b)}}
  \end{picture}
...
\begin{figure}[!ht]
 \begin{center}
  \unitlength1.0cm % coordinates in cm
  \begin{picture}(14.,8.0)  %ys(25.,6.0)
   \put( -0.5,  0.0){\includegraphics[width=7.55cm]{figures/slb/br_dss1primel.eps}}
   \put(  8.0,  0.0){\includegraphics[width=7.8cm]{figures/slb/br_dss00l.eps}}
   \put(  5.5,  6.8){{\large\bf a)}}
   \put( 14.0,  6.8){{\large\bf b)}}
  \end{picture}
  \caption{Average of the product of branching fraction (a) 
