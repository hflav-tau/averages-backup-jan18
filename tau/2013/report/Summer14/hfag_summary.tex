...
%%  ~~ $\stwob \equiv \sin\! 2\phi_1$ & $0.679 \pm 0.020$ \\
%%  ~~ $\beta \equiv \phi_1$          & $\left( 21.4 \pm 0.8 \right)^\circ$ \\
%%  ~~ $-\etacp S_{\phi \KS}$       & $0.74\,^{+0.11}_{-0.13}$ \\
%%  ~~ $-\etacp S_{\etapr \Kz}$       & $0.59 \pm 0.07$ \\
%%  ~~ $-\etacp S_{\KS \KS \KS}$       & $0.72 \pm 0.19$ \\
%%  ~~ $-\etacp S_{\Kp \Km \KS}$       & $0.68\,^{+0.09}_{-0.10}$ \\
%%  ~~ $-\etacp S_{\jpsi \piz}$       & $0.93 \pm 0.15$ \\
%%  ~~ $S_{K^* \gamma}$       & $-0.16 \pm 0.22$ \\
%%  ~~ $S_{\pi^+\pi^-}$               & $-0.65 \pm 0.07$ \\  
%%  ~~ $C_{\pi^+\pi^-}$               & $-0.36 \pm 0.06$ \\  
...
%% \hline
%% %~~$a^{\rm ind}_{CP}$ & $(-0.025 \pm 0.231)\%$ \\
%% %~~$\Delta a^{\rm dir}_{CP}$ & $(-0.656 \pm 0.154)\%$ \\
