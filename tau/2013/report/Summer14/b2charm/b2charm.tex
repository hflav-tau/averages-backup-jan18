...
\newcommand{\btocharmfig}[1]{\begin{figure}[H]\begin{center}\includegraphics[width=0.99\textwidth]{b2charm/#1}\caption{Summary of the averages from Table~\ref{tab:b2c:#1}.}\label{fig:b2c:#1}\end{center}\end{figure}}
\newcommand{\btocharm}[1]{\input{b2charm/#1}\btocharmfig{#1}}
