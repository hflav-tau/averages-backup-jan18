...
Tom Junk~\cite{junk:2007:cdfnote}. The systematic uncertainties, which
affect $S_i$ and $B_i$, are accounted by randomly extracting the
corresponding nuisance parameters from Gaussian distributions.
