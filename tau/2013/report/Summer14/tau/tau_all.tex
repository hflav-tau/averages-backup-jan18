...
%%%%%%%%%%%%%
%\input{tau/tau-lfv}
\input{tau/hfag-tau-lfv.tex}
%%--- begin remove section title for HFAG report
%\renewcommand{\tausection}[1]{}
\input{tau/tau-lvf-limits-plot}
\input{tau/hfag-tau-lfv_combination.tex}
\let\tausection\subsection
%%--- end
\let\cite\citeOld
\end{fleqn}
