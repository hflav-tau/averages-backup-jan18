...
\end{tabularx}}
\noindent It was realised that the PDG measurement for \htuse{Gamma44.gn}, which is
exclusively determined by one ALEPH
...
includes two modes that have a tiny overlap:
\begin{align*}
...
PDG 2013 value for the $s$-quark mass $m_s = \htuse{m_s}$~\cite{PDG_2013}
